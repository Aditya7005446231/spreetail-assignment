...
function App() {
  ...
  const fetchBalances = async () => {
    try {
      const res = await fetch(`${API_BASE}/expenses/balances?group_id=1`);
      const data = await res.json();
      setBalances(data);
    } catch (err) {
  ...
  const fetchSettlementPaths = async () => {
    try {
      const res = await fetch(`${API_BASE}/expenses/settlements-path?group_id=1`);
      const data = await res.json();
  ...
  const fetchExpenses = async () => {
    try {
      const res = await fetch(`${API_BASE}/expenses/?group_id=1&verified_only=true`);
      const data = await res.json();
      setExpenses(data);
    } catch (err) {
  ...
  const fetchAnomalies = async () => {
    try {
      const res = await fetch(`${API_BASE}/imports/anomalies`);
      const data = await res.json();
      setAnomalies(data);
    } catch (err) {
  ...
  const handleAuditClick = async (user) => {
    ...
    try {
      const res = await fetch(`${API_BASE}/expenses/audit/${user.user_id}?group_id=1`);
      const data = await res.json();
      setAuditTrail(data);
  ...
  const handleFileUpload = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`${API_BASE}/imports/upload?clear_existing=true`, {
        method: "POST",
        body: formData,
      });
  ...
  const handleResolveAnomaly = async (anomalyId, choice) => {
    try {
      const res = await fetch(`${API_BASE}/imports/anomalies/${anomalyId}/resolve`, {
        method: "POST",
  ...
  const handleAddExpenseSubmit = async (e) => {
    ...
    try {
      const res = await fetch(`${API_BASE}/expenses/?group_id=1`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
    ...
    <div className="app-container animate-fade-in">
      <header>
        <div className="logo-section">
          ...
          <div className="logo-text">Spreetail Split</div>
        </div>
